...
const servoConfig = {
    ...
    rightBack: {
        alpha: { controller, pin: 2, right_address },
        beta: { controller, pin: 1, right_address },
        gamma: { controller, pin: 0, right_address },
    },
    leftFront: {
        alpha: { controller, pin: 2, address: left_address },
        beta: { controller, pin: 1, address: left_address },
        gamma: { controller, pin: 0, address: left_address },
    },

    leftMiddle: {
        alpha: { controller, pin: 8, address: left_address },
        beta: { controller, pin: 9, address: left_address },
        gamma: { controller, pin: 10, address: left_address },
    },
